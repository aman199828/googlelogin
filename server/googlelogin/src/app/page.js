    ...
    <>
      <div className="max-w-md border border-black shadow-xl py-5 flex flex-col justify-between mx-auto h-[700px] my-10 rounded-2xl">
        ...
        <div className="text-center mt-10">
          ...
          <p className="my-2">
            start creating & selling your brand to your audience. Customizing to
            your heart's desire! What is possible is infinite!
          </p>
          <div className="flex gap-3 items-center bg-gray-50 py-2 rounded-md w-fit mx-auto px-5 border mt-5">
            <Image
              src={logo}
              alt="Picture of the author"
              width={30}
